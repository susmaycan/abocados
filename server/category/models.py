...
class Category (TranslatableModel):
    translations = TranslatedFields(
        name=models.CharField(_('name'), max_length=180, null=False, blank=False, unique=True),
    ...
    picture = models.FileField(_('picture'), upload_to=upload_location, null=True, blank=True)
