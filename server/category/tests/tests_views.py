...
from rest_framework.status import HTTP_200_OK, HTTP_401_UNAUTHORIZED, HTTP_403_FORBIDDEN, HTTP_404_NOT_FOUND
...
class CategoryTestCase(TestCase):
    ...
    def test_create_category_as_a_member(self):
        response = self.make_create_category_call(
            data={},
    ...
    def test_retrieve_category_list_ok(self):
        ...
        response = self.make_retrieve_category_list_call(
