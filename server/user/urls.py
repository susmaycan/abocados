...
from user.views import UserViewSet, AuthViewSet, UserRecipesViewSet, UserFavouriteRecipesViewSet
...
user_recipe_router = routers.NestedSimpleRouter(
    router,
    r'users',
    lookup='user')
...
user_recipe_router.register(
    ...
    basename='user-favourite-recipes'
)
