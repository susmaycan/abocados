...
class UserUpdateSerializer(serializers.ModelSerializer):
    ...
    picture = serializers.FileField(allow_empty_file=True, allow_null=True, required=False)
    email = serializers.EmailField(
        required=False,
        validators=[UniqueValidator(queryset=User.objects.all())]
    )
...
class ActivateAccountSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        try:
            ...
            return new_data
        except (UnicodeDecodeError, DjangoUnicodeDecodeError, User.DoesNotExist, ValueError):
            raise serializers.ValidationError(_('Token is invalid or expired'))
