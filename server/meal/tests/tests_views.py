...
from rest_framework.status import HTTP_200_OK, HTTP_201_CREATED, HTTP_204_NO_CONTENT, HTTP_401_UNAUTHORIZED, HTTP_400_BAD_REQUEST, HTTP_403_FORBIDDEN, HTTP_404_NOT_FOUND
...
class MealTestCase(TestCase):
    ...
    def test_create_meal_ok(self):
        ...
        response = self.make_create_meal_call(
            data=body,
            user=self.user1
        )
    ...
    def test_create_meal_with_empty_fields(self):
        ...
        self.assertEqual(response.status_code, HTTP_400_BAD_REQUEST)
        self.assertEqual(response.content['date'][0], 'Date has wrong format. Use one of these formats instead: YYYY-MM-DD.')
